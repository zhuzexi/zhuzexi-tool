...
function convert(val) {
    ...
    return [
        {name: "HEX",value: color.toHex(), color: color.toHex()},
        {name: "RGB", value: color.toRGB(), color: color.toHex()},
        {name: "RGBA", value: color.toRGBA(), color: color.toHex()},
        {name: "ARGB", value: color.toARGB(), color: color.toHex()},
        {name: "HSL", value: color.toHSL(), color: color.toHex()}
    ]
}
export default convert
let colorList = colors.map(item => {
    let obj = {};
